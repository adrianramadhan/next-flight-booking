...
export default async function ChooseSeatPage({ params }: ChooseSeatProps) {
  ...
  return (
    <section
      id="Chosse-Seat"
      className="container flex flex-col sm:flex-row items-center sm:items-start justify-between sm:w-[904px] pt-10 mx-auto sm:pb-0 min-h-screen text-white bg-flysha-black font-poppins"
    >
